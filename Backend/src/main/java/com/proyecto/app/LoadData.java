...
import com.proyecto.app.repositories.RoleRepository;

@Configuration 
class LoadData {
	
	@Bean
	CommandLineRunner llenarBD (RestauranteRepository  restauranteRepository, ReservaRepository reservaRepository, ClienteRepository clienteRepository, RoleRepository roleRepository, BCryptPasswordEncoder bCryptPasswordEncoder){
		return args ->{
...
// ROLES
			...
			customerRole.setNombre("CUSTOMER");
...
//CLIENTES			
			...
			cliente2.setPassword(bCryptPasswordEncoder.encode("12345"));
			cliente2.setNumero("3186453854");
			cliente2.setRol(adminRole);
			...
			cliente3.setPassword(bCryptPasswordEncoder.encode("12345"));
			cliente3.setNumero("3220910291");
			cliente3.setRol(customerRole);
			...
			cliente4.setUsername("andrea");
			cliente4.setPassword(bCryptPasswordEncoder.encode("12345"));
			cliente4.setNumero("3120310191");
			cliente4.setRol(customerRole);
			...
			cliente5.setUsername("julian");
			cliente5.setPassword(bCryptPasswordEncoder.encode("12345"));
			cliente5.setNumero("3134310199");
			cliente5.setRol(customerRole);
